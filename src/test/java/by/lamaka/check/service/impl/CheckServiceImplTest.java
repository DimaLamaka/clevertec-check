...
class CheckServiceImplTest {
    ...
    void setUp() {
        ...
        checkService = new CheckServiceImpl(validation, checkDAO,mailService,manager);
    }

    @Test
    void saveCheckShouldSuccess() throws ValidateException, IOException, EmptyProductList, IdNotFoundException, MailAuthenticationException {
    ...
    @Test
    void saveCheckWithCardShouldSuccess() throws ValidateException, IOException, EmptyProductList, IdNotFoundException, MailAuthenticationException {
    ...
    @Test
    void saveCheckWithEqualsProductsShouldSuccess() throws ValidateException, IOException, EmptyProductList, IdNotFoundException, MailAuthenticationException {
